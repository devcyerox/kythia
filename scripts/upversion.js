 ...
 * @version 0.9.9-beta-rc.4 in file headers to match the version specified in package.json.
 ...
 * - Updates the @version 0.9.9-beta-rc.4 in file headers to the latest version.
